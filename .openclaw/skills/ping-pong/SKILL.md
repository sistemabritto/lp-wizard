...
name: ping-pong
description: |
  Entrevista estratégica — Geraldo e Vera conduzem 18 perguntas.
  Gera PRD + contexto-projeto + plano com 7 épicos ao final.
version: "1.0"
author: LP Wizard
tags:
  - entrevista
...
- **Geraldo** — PM Pitbull (leia perfil completo antes de começar)
- **Vera** — Estrategista (leia perfil completo antes de começar)
...
Após completar o ping-pong, execute `/escrever-copy` para criar a copy da landing page.
